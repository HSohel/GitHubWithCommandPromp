...
public class RealApr extends NavigationBar {
    ...
    public RealApr validateAPR1(String interestRate1) {
        //Validate APR
        String aprRate1 = ActOn.element(driver, ActualAPR).getTextValue();
        String color="Red, White, Blue";
        //ActOn.element(driver, By.xpath("//*[@id='CalcForm']//label[text()='"+color+"']")).click();
        LOGGER.debug("Validate Expected APR :"+interestRate+" with Actual APR :"+aprRate1);
        Assert.assertEquals(aprRate1, interestRate);
        return this;
    }
